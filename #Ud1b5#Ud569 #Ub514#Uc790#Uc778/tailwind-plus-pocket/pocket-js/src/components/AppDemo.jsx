    ...
    <AppScreen>
      <AppScreen.Body>
        <div className="p-4">
          ...
          <div className="zzik-card mt-3 border-t border-gray-200 pt-5">
            ...
            <div className="zzik-card mt-3 rounded-lg bg-gray-50 ring-1 ring-black/5 ring-inset">
              <Chart
                width={286}
                height={208}
                paddingX={16}
            ...
            <div className="zzik-card mt-4 rounded-lg bg-cyan-500 px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
