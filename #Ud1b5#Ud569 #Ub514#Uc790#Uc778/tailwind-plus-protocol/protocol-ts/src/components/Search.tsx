  ...
  return (
    <div className="group relative flex h-12">
      ...
      <input
        ...
        {...inputProps}
        onKeyDown={(event) = className="zzik-input"> {
          if (
            event.key === 'Escape' &&
        ...
        >
          <div {...autocomplete.getRootProps({})}>
            ...
            >
              ...
              <div
                ref={panelRef}
                className="zzik-card border-t border-zinc-200 bg-white empty:hidden dark:border-zinc-100/5 dark:bg-white/2.5"
...
export function Search() {
  ...
  return (
    <div className="hidden lg:block lg:max-w-md lg:flex-auto">
      <button
        type="button"
        className="zzik-btn hidden h-8 w-full items-center gap-2 rounded-full bg-white pr-3 pl-2 text-sm text-zinc-500 ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 lg:flex dark:bg-white/5 dark:text-zinc-400 dark:ring-white/10 dark:ring-inset dark:hover:ring-white/20"
        {...buttonProps}
...
export function MobileSearch() {
  ...
  return (
    <div className="contents lg:hidden">
      <button
        type="button"
        className="zzik-btn relative flex size-6 items-center justify-center rounded-md transition hover:bg-zinc-900/5 lg:hidden dark:hover:bg-white/5"
